...
* The walking sim, [*Gone Home*](https://gonehome.game/) (2013), by the Fullbright Company 
...
* The blog series, [*50 Years of Text Games: From Oregon Trail to A.I. Dungeon*](https://if50.substack.com/) (2021), by Aaron A. Reed 
...
* Watch Young-Hae Chang Heavy Industries' [*THE M00D 0F THE M0MENT*](https://www.yhchang.com/THE_MOOD_OF_THE_MOMENT_V.html) and complete the worksheet for it (see Brightspace attachment). Ensure the audio is enabled. CW: flashing images of text; unwanted advance by a male-coded character
...
* Play Marina Kittaka's [*Secrets Agent*](https://even-kei.itch.io/secrets-agent) and complete the worksheet for it (see Brightspace attachment). Ensure the audio is enabled and try to play the game to completion. CW: discussion of body image and voice perception. Check out [*Sephonie*](https://store.steampowered.com/app/1248840/Sephonie/), too, if you'd like. 
...
* Watch Amanda Strong and Leanne Betasamosake Simpson's [*Biidaaban (The Dawn Comes)*](https://www.youtube.com/watch?v=vWjnYKyiUB8) and complete the worksheet on it (see Brightspace attachment). Ensure the audio is enabled. CW: settler colonialism and violence; surveillance; some horror motifs (especially the music)
...
* Read Nalo Hopkinson's "Message in a Bottle" (available in Brightspace) and complete the worksheet on it (see Brightspace attachment). CW: racism; sexism; ableism; settler colonialism; gaslighting; sexual content 
* Expect a review of key concepts we've discussed thus far.
...
* Spend an hour learning more about a game or interactive fiction, such as Cecile Richard's [*Under a Star Called Sun*](https://haraiva.itch.io/under-a-star-called-sun), mentioned during Tuesday's lecture. Try some internet searches and even playing the game or fiction itself.
...
* Listen to Janina Matthewson and Jeffrey Cranor's [*Within the Wires*](http://www.nightvalepresents.com/withinthewires), Season 1, Episode 1. Complete the worksheet on it (see Brightspace attachment) and feel free to listen to more episodes if you wish. CW: bugs (including bug abuse); themes related to gaslighting, stalking, mental health, and pathologization
* Expect a lecture on ways of listening to audio in fiction, including dialogue (DX), sound effects (SFX), background sound (BG), music (MX), Foley (FOL), and voice-over (VO) as well as causal, semantic, and reduced listening.  
...
* Expect a workshop on the concepts of manipulation and massage in media. 
...
* Play or watch the Fullbright Company's [*Gone Home*](https://gonehome.game/). Complete the worksheet on it (see Brightspace attachment) and ensure the audio is enabled. You don't need to play the game to completion, but feel free to do so (it takes about 2-3 hours). CW: horror motifs, including implied jumpscares; homophobia and homophobic parents; voyeurism; allusions to child abuse and alcoholism
* Expect a lecture and group discussion about *Gone Home*, with attention to movement (including walking sims, first-person shooters, and being "on rails"), mechanics (including "snooping" and making your own fun), melodrama (external projection of internal states), and ludonarrative dissonance. 
...
* Spend an hour learning more about a game or interactive fiction, such as Fellow Traveller's [*Citizen Sleeper*](https://www.fellowtraveller.games/citizen-sleeper), mentioned during Wednesday's lecture. Try some internet searches and even playing the game or fiction itself.  
* Expect a review of concepts and techniques for approaching audio in fiction. 
* Also expect a review of [Prompt 2](prompt2.html), a response to which is due Tuesday.  
...
* Expect a lecture on ways of seeing media and fiction, with a focus on images (including optical, graphic, mental, and perceptual images) and comics terminology (like panels, tracks, gutters, captions, spreads, bleed, horizon lines, and speech bubbles).
...
* Expect a workshop on how comics tell stories.  
...
* Play or watch Toby Fox and Temmie Chang's [*Undertale*](https://undertale.com/) and complete the worksheet on it (see Brightspace attachment). Ensure the audio is enabled. You don't need to play the game to completion (one run may take 4-10 hours, and the game is designed for multiple runs), but feel free to do so. CW: implied torture and child abuse; death of a parent and child; suicide; themes related to depression, anxiety, and violence
* Expect a lecture on interpreting types of text in fiction (such as scripts, symbols, code, instructions, and typefaces), with some examples from *Undertale*.  
* Also expect a review of [Prompt 3](prompt3.html), a response to which is due Friday. 

*Wednesday, November 2nd* 

* Expect a workshop on *Undertale*, with attention to meaning (including lore, roleplay, and metafiction), motivation (such as player commitment to multiple runs), minigames (including "bullet hell" and random encounters), nostalgia (including pixelated art, MS Paint, and GameMaker), and toxic cultures in gaming. 

*Friday, November 4th* 

* Submit your response to [Prompt 3](prompt3.html) via Brightspace.
* Expect a review of the course thus far. What have we learned? What didn't we spend enough time on? 
...
* Check out Aaron Reed's [*50 Years of Text Games*](https://if50.substack.com/archive) project, pick a year (between 1971 and 2020), and read about the game for that year. Come to class prepared to talk about it. 
* Expect a large group discussion about text games. 
* We will return marks for [Prompt 3](prompt3.html) by this class meeting.

*Wednesday, November 16th* 

* Read (or play?) Porpentine Charity Heartscape and Brenda Neotenomie's [*With Those We Love Alive*](http://collection.eliterature.org/3/work.html?work=with-those-we-love-alive). Complete the worksheet for it (see Brightspace attachment) and ensure the audio is enabled. Try to read / play it to completion. CW: child abuse; themes related to self-harm, trauma, and structural violence
* Expect a lecture and large group discussion about *WTWLA*, with attention to markup (including HTML and Twine), choice (including lists and rituals), and the labour of survival (including the mechanics of sleeping and hormone application).  

*Friday, November 18th* 

* Review the [prompt for revisions](revisions.html). You may revise your response to Prompt 1, 2, or 3. This response is optional and is due in Brightspace by Friday, December 2nd.  
* Expect a review of concepts and techniques for approaching text in fiction. 
...
* Expect a lecture on the interfaces we've encountered this term, plus some new ones, too. We'll also discuss the role of action (as input, output, and feedback) in fiction. 
...
* Bring the title of a game or interactive fiction with an interesting interface to share during class today. Come prepared with a sentence or two explaining why you selected it.
* Expect a large group discussion about the games and interactive fictions you shared.

*Wednesday, November 30th* 

* Expect a review of concepts and techniques for approaching interfaces in fiction. 
* Also expect a review of what we learned this term. 
